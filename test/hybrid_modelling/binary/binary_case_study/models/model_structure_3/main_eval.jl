...
for l in neurons_test #l=2
	...
	global nn, p_init, st = initialize_neural_network(saveat = joinpath(@__DIR__, "neurons_$l"), input = 2, neurons = l, output = 2, activation = (tanh_fast, softplus))
	global nn2, p_init2, st2 = initialize_neural_network(saveat = joinpath(@__DIR__, "neurons_$l"), input = 2, neurons = l, output = 1, activation = (tanh_fast, softplus))
