...
for l in neurons_test #l=2
	...
	global nn2, p_init2, st2 = initialize_neural_network(saveat = joinpath(@__DIR__, "neurons_$l"), input = 4, neurons = l, output = 1, activation = (tanh_fast, softplus))
	...
	evaluate_metrics_training(@__DIR__, l, 1, 3)
